...
import { AlertTriangle, Search, Filter, Clock, ChevronDown, Eye, CheckCircle, XCircle } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-gray-400 mt-2">Monitor and manage security threats in real-time</p>
      </motion.div>
      ...
      >
        ...
        <div className="flex gap-2 overflow-x-auto">
          {(['all', 'critical', 'high', 'medium', 'low'] as const).map((severity) => (
            ...
            >
              {severity.charAt(0).toUpperCase() + severity.slice(1)} ({alertCounts[severity]})
            </button>
          ))}
        </div>
      </motion.div>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap gap-4 text-sm">
                      <div className="flex items-center space-x-2">
                        ...
                        <code className="text-gray-300 bg-slate-900/50 px-2 py-1 rounded">{alert.source}</code>
                      </div>
                      <div className="flex items-center space-x-2">
                        <span className="text-gray-500">Destination:</span>
                        <code className="text-gray-300 bg-slate-900/50 px-2 py-1 rounded">{alert.destination}</code>
                      </div>
                      <div className="flex items-center space-x-2">
