            ...
            <tbody className="divide-y divide-slate-800">
              {users.map((user) => (
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <span className={`px-3 py-1 rounded-full text-xs font-medium border inline-block ${getRoleBadgeColor(user.role)}`}>
                      {user.role}
                    </span>
                  </td>
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-2">
                      <div className={`w-2 h-2 rounded-full ${user.status === 'active' ? 'bg-green-500' : 'bg-gray-500'} animate-pulse`} />
                  ...
                  <td className="px-6 py-4">
                    <div className="text-sm text-gray-400">
                      ...
                      <p className="text-xs text-gray-500">{user.lastLogin.split(' ')[1]}</p>
                    </div>
                  </td>
