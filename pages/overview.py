...
def show():
    ...
    with col1:
        st.metric(
            ...
            "2.4M",
            "12% ↗️",
            help="Packets analyzed in last 24 hours"
        )
    ...
    with col2:
        st.metric(
            ...
            "3 ↗️",
            delta_color="inverse",
            help="High priority alerts requiring attention"
        )
    ...
    with col3:
        st.metric(
            ...
            "98.7%",
            "0.5% ↗️",
            help="Current detection performance"
        )
    ...
    with col4:
        st.metric(
            ...
            "1.2%",
            "0.3% ↘️",
            help="Incorrect alerts in last 24 hours"
        )
