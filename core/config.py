...
class SessionKeys(StrEnum):
    ...
    SHOW_BACKUP_CODE_LOGIN = "show_backup_code_login"
    SHOW_BACKUP_CODE_WARNING = "show_backup_code_warning"
    SHOW_MFA_SETUP = "show_mfa_setup"
    SHOW_NEW_BACKUP_CODES = "show_new_backup_codes"
    TEMP_MFA_SECRET = "temp_mfa_secret"
    USER = "user"
    VERIFY_DISABLE_MFA = "verify_disable_mfa"
